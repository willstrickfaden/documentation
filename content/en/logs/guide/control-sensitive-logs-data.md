...
To apply the [restriction query][19] to some roles but not others, work within your existing Data Access structure.  Previously Unrestricted Access roles should be moved to Restricted Access under a query that selects for all logs except those containing sensitive data.  Previously Restricted Access roles should have the existing query modified to also exclude the sensitive data.

### Patch your archives

If you have to patch your archives to remove sensitive data, refer to the [format of archives][20] generated by Datadog documentation.

## Support

If you have a specific compliance questions or need help, contact Datadog [support][21]. When you contact support, it is helpful for you to have the following information available:

* The sensitive outline query or anything that could define sensitive data such as a timerange, a service, or an environment.
* Whether you use [Sensitive Data Scanner][22].
...
[19]: /logs/guide/logs-rbac-permissions/?tab=ui#create-a-restriction-query
[20]: /logs/archives/?tab=awss3#format-of-the-archives
[21]: /help/
[22]: https://www.datadoghq.com/blog/sensitive-data-scanner/
