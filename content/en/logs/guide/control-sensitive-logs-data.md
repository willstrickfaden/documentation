...
To apply the [restriction query][19] to some roles but not others, work within your existing Data Access structure. Move previously Unrestricted Access roles to Restricted Access under a query for all logs except those containing sensitive data. Modify the existing queries for previously Restricted Access roles to also exclude the sensitive data.
